...
`;const l={class:"menu-editor"},m={__name:"Interface",setup(d){const e=r(null);console.log(t);let n=null;return s(()=>{n=a.create(e.value,{value:t,language:"typescript",readOnly:!0}),console.log(n)}),(p,v)=>(u(),c("div",l,[i("div",{ref_key:"$monaco",ref:e,class:"monaco-editor"},null,512)]))}},h=o(m,[["__scopeId","data-v-2cce324e"]]);export{h as default};
